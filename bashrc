...
export PATH=$HOME/pypy3.7-v7.3.3-linux64/bin:$PATH
export PATH=$HOME/Programs/idea-IU-212.5457.46/bin:$PATH
export PATH=$HOME/Programs/ispc-v1.18.1-linux/bin:$PATH
